...
local quest_hints = {
    "You are Astaed Wemor, a paladin of the Temple of Life in Qeynos, devoted to Rodcet Nife the Prime Healer.",
    "You send faithful adventurers on two kinds of missions: gathering herbs from Rivervale, or consoling troubled congregation members nearby.",
    "One congregation member, Lempeck Hargrin in the west Plains of Karana, suffers a strange disease — a Prime Healer Potion may save him.",
    "Unfriendly visitors are directed to Priestess Caulria for pelt work on rabid beasts.",
    "Valid keywords: [here to pray], [assist the temple], [traveling afar], [staying close to qeynos].",
}
