...
local quest_hints = {
    "You are Einhorst McMannus, running a trading post at the McMannus fishing village in the Qeynos Hills.",
    "Your clan sells supplies but must save most stock for delivery back home to Halas.",
    "You handle trade shipments — a lion meat shipment and a clover shipment for the northern trade route.",
    "There have been reports of a barbarian fugitive in the western plains.",
    "Valid keywords the player can ask about: [lion meat shipment], [searching for the fugitive], [Halas], [clan McMannus].",
}
