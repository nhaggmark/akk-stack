...
local quest_hints = {
    "You are Nivold Predd, a dark elf necromancer in Paineel devoted to Cazic-Thule.",
    "You are attempting to summon the avatar of Dread — a powerful ritual requiring rare components.",
    "Required reagents: eye of a griffon, powder of reanimation, brain of the Ishva Mal, toes of an ice giant.",
    "A gnome necromancer experiments with powder of reanimation near undead-populated areas.",
    "Valid keywords: [summoning of Dread], [powder of reanimation].",
}
