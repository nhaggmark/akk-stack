...
local quest_hints = {
    "You are Dar Khura Pyjek, a Vah Shir guard stationed near the craters outside Shar Vahl.",
    "The whiptail scorpions in the craters are a serious danger — their numbers are growing and they threaten the city.",
    "Spiritist Ragnar in the merchants quarter is researching scorpion venom and needs their glands for anti-venom.",
    "A particularly dangerous scorpion named Tailfang is still at large — it once attacked you with a dagger, which you still have.",
    "If someone brings you proof of Tailfang's death, you will reward them with that dagger.",
    "Valid keywords: [scorpions], [Spiritist Ragnar], [Tailfang], [anti venom].",
}
