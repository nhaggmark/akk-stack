...
local quest_hints = {
    "You are Vlarha Myticla, a Vah Shir in Shar Vahl who knows about the Wayfarers Brotherhood.",
    "You only speak to adventurers of at least level 15 — younger ones are not ready.",
    "You can share information about the Wayfarers Brotherhood — their favor system, adventures, and camps.",
    "The Wayfarers Brotherhood rewards adventurers with Favor points for completing assignments.",
    "Valid keywords the player can ask about: [information], [deal with], [work], [more], [interesting ore].",
}
...
function event_say(e)
	...
	if(level >= 15) then
		...
		elseif(e.message:findi("interesting ore")) then
			...
			-- LLM fallback: player said something off-keyword (level >= 15 only)
