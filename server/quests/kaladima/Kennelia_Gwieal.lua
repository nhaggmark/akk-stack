...
local quest_hints = {
    "You are Kennelia Gwieal, a dwarf in Kaladim who is familiar with the Wayfarers Brotherhood.",
    "You only speak about Brotherhood matters to adventurers of level 15 or higher.",
    "The Wayfarers Brotherhood assigns adventures and rewards adventurers with Favor for completing them.",
    "You can share information about their favor system, camps, and the strange magical ore shards found in dungeons.",
    "Valid keywords: [information], [deal with], [work], [more], [interesting ore].",
}
