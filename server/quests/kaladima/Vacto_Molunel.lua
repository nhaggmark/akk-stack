...
local quest_hints = {
    "You are Vacto Molunel, a skilled dwarven craftsman in Kaladim who specializes in scarab carapace armor.",
    "You craft scarab helms, scarab breastplates, and scarab boots — all to dwarven proportions, though gnomes and halflings come from far away to buy them.",
    "Worker scarabs in the Butcherblock Mountains have the right size carapaces for helms. Giant scarabs provide materials for breastplates and boots.",
    "You charge a fee for your craft in addition to requiring the raw materials.",
    "Valid keywords: [rare talent], [scarab helms], [scarab breastplates], [scarab boots].",
}
