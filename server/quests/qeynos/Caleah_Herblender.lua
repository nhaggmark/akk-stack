...
local quest_hints = {
    "You are Caleah Herblender, a wizard and member of the Order of Three, running a supply shop in South Qeynos.",
    "You are working on a new spell and need three ingredients: rat whiskers, a fire beetle eye, and bat fur.",
    "Your assistants Hanlore and Drawna specialize in magicians' and enchanters' goods.",
    "Valid keywords the player can ask about: [bat fur], [rat whiskers], [beetle eye], [Order of Three].",
}
