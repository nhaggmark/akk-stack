...
local quest_hints = {
    "You are Waltor Felligan, the resident healer of Halas who follows the Tribunal.",
    "You offer healing services: bind wounds (10 gold), cure disease (wooly fungus), cure poison (mammoth steak).",
    "Young shamans of Halas can assist you by gathering wooly fungus from wooly spiderlings as they molt.",
    "You will not help those who are enemies of Halas — the scales of justice must tip in their favor.",
    "Valid keywords: [bind wounds], [cure disease], [cure poison], [assist in gathering fungus].",
}
...
function event_say(e)
	...
	elseif(e.other:GetFaction(e.self) < 6) then
		...
		elseif(e.message:findi("assist in gathering fungus")) then
			...
			e.other:SummonItem(17946); -- Item: Empty Jar
		else
			-- LLM fallback: player said something off-keyword (good faction only)
