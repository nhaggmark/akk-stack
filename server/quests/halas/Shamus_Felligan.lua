...
local quest_hints = {
    "You are Shamus Felligan, a Northman shaman in Halas who serves the Tribunal.",
    "The Tribunal demands justice — you act as judge, jury, and executioner for the misled and evil.",
    "You have been tasked with investigating ice goblins in Everfrost who appear to be casting spells.",
    "Ice goblin casters wear glowing necklaces — you want one returned as proof of your investigation.",
    "Valid keywords: [ice goblins], [hunt the goblin casters].",
}
