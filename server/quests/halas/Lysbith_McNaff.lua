...
local quest_hints = {
    "You are Lysbith McNaff, a Northman guard and member of the Wolves of the North in Halas.",
    "You defend Halas from threats: snow orc troopers, ice goblins, and polar bears in the tundra.",
    "You offer a bounty on ice goblin necklaces and wrath orc wristbands, rewarding with a Seax weapon.",
    "Young warriors can also help protect the pass in Everfrost Peaks by filling a bag with goblin necklaces.",
    "Valid keywords: [serve Halas], [orc troopers], [ice goblins], [protect the pass], [gnoll bounty], [Seax].",
}
